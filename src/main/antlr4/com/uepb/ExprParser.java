...
public class ExprParser extends Parser {
	...
	public static final int
		...
		RPAREN=10, SEMICOLON=11, ASSIGN=12, LBRACE=13, RBRACE=14, IF=15, WHILE=16, 
		PRINT=17, INPUT=18, VAR=19, EQ=20, NEQ=21, LT=22, LE=23, GT=24, GE=25, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LPAREN", "RPAREN", "SEMICOLON", "ASSIGN", "LBRACE", "RBRACE", "IF", 
			"WHILE", "PRINT", "INPUT", "VAR", "EQ", "NEQ", "LT", "LE", "GT", "GE", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1018878L) != 0)) {
				{
				{
				setState(28);
				stat();
